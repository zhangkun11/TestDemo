...
public class DumpEditor extends BasicActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Color caption.
        SpannableString keyA = BaseApplication.colorString(
                getString(R.string.text_keya),
                getResources().getColor(R.color.light_green));
        SpannableString keyB =  BaseApplication.colorString(
                getString(R.string.text_keyb),
                getResources().getColor(R.color.dark_green));
        SpannableString ac = BaseApplication.colorString(
                getString(R.string.text_ac),
                getResources().getColor(R.color.orange));
        SpannableString uidAndManuf = BaseApplication.colorString(
                getString(R.string.text_uid_and_manuf),
                getResources().getColor(R.color.purple));
        SpannableString vb = BaseApplication.colorString(
        ...
        SpannableString updateText = BaseApplication.colorString(
        ...
        if (getIntent().hasExtra(EXTRA_DUMP)) {
            ...
            if (BaseApplication.getUID() != null) {
                setTitle(getTitle() + " (UID: " + BaseApplication.byte2HexString(
                        BaseApplication.getUID())+ ")");
            }
            ...
            initEditor(BaseApplication.readFileLineByLine(file, false, this));
            setIntent(null);
     ...
     * @see BaseApplication#isValidDumpErrorToast(int, Context)
     * @see #initEditor(String[])
     */
        ...
        if (file.exists()) {
            ...
            .setPositiveButton(R.string.action_replace,
                ...
                public void onClick(DialogInterface dialog, int which) {
                    // Replace.
                    if (BaseApplication.saveFile(file, mLines, false)) {
            ...
            .setNeutralButton(R.string.action_append,
                ...
                public void onClick(DialogInterface dialog, int which) {
                    // Append.
                    if (BaseApplication.saveFile(file, mLines, true)) {
                        Toast.makeText(context, R.string.info_save_successful,
                                Toast.LENGTH_LONG).show();
                    } else {
                        Toast.makeText(context, R.string.info_save_error,
     ...
     * @see BaseApplication#isValidDump(String[], boolean)
     * @see BaseApplication#isValidDumpErrorToast(int, Context)
     */
    private void initEditor(String[] lines) {
        int err = BaseApplication.isValidDump(lines, true);
        if (err != 0) {
            BaseApplication.isValidDumpErrorToast(err, this);
    ...
    private void decodeValueBlocks() {
        ...
        for (int i = 0; i < mLines.length; i++) {
            if (mLines[i].startsWith("+")) {
                ...
                if (BaseApplication.isValueBlock(mLines[i])) {
                    // Header.
     ...
     * The dump will be checked and stored in the {@link BaseApplication#TMP_DIR}
    ...
    private void shareDump() {
        ...
        File file = new File(Environment.getExternalStoragePublicDirectory(
                BaseApplication.HOME_DIR) + "/" + BaseApplication.TMP_DIR, fileName);
        BaseApplication.saveFile(file, mLines, false);
    ...
    private SpannableString colorDataBlock(String data, boolean hasUID) {
        ...
        if (hasUID) {
            ...
            ret = new SpannableString(TextUtils.concat(
                    BaseApplication.colorString(data,
                            getResources().getColor(R.color.purple))));
        } else {
            if (BaseApplication.isValueBlock(data)) {
                // Value block.
                ret = BaseApplication.colorString(data,
                        getResources().getColor(R.color.yellow));
            } else {
                // Just data.
