...
public class ValueBlocksToInt extends BasicActivity {
    ...
    private void addPosInfoRow(String value) {
        ...
        header.setText(BaseApplication.colorString(value,
    ...
    private void addValueBlock(String hexValueBlock) {
        ...
        value.setText(BaseApplication.colorString(hexValueBlock.substring(0, 8),
        ...
        byte[] asBytes = BaseApplication.hexStringToByteArray(
                hexValueBlock.substring(0, 8));
        BaseApplication.reverseByteArrayInPlace(asBytes);
        ByteBuffer bb = ByteBuffer.wrap(asBytes);
        int i = bb.getInt();
        String asInt = "" + i;
        value.setText(BaseApplication.colorString(asInt,
